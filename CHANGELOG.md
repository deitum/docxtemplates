...
- 08f9cfa: Fix `ImageError` so that it is recognised by `instanceof`. `CommandExecutionError`
...
- 2c26b7f: Stop deleting table cells that only contain commands but are not part of a
